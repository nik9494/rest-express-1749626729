...
export function HeroRoomCard({ onClick }: HeroRoomCardProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-amber-50 to-yellow-100 rounded-xl shadow-md p-4 border border-amber-300 relative overflow-hidden hover:shadow-lg transition-shadow">
